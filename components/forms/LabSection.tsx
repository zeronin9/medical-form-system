          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-slate-200 p-5 shadow-sm hover:border-slate-300 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                ...
                <div><label className={labelClass}>% Predicted FVC <BadgeChevron/></label><input type="text" name="pre_fvc" value={formData.pre_fvc || ''} onChange={handleChange} className={inputClass} placeholder="Cth: 85" /></div>
              </div>
              <div className="grid grid-cols-2 gap-4 mb-3">
                ...
                <div><label className={labelClass}>% Predicted FEV1 <BadgeChevron/></label><input type="text" name="pre_fev1" value={formData.pre_fev1 || ''} onChange={handleChange} className={inputClass} placeholder="Cth: 90" /></div>
              </div>
              <div><label className={labelClass}>FEV1 / FVC Ratio (%) <BadgeChevron/><BadgeMLC/></label><input type="text" name="ev1_vc" value={formData.ev1_vc || ''} onChange={handleChange} className={inputClass} placeholder="Cth: 80" /></div>
            </div>
