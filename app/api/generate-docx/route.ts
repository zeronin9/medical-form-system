...
export async function POST(request: Request) {
  try {
    ...
    const doc = new Docxtemplater(zip, {
      ...
      nullGetter: function() { return ""; } // Mencegah undefined
    });
    ...
    doc.render({
      ...
      emp_id: formData.idPassport || "", personal_id: formData.idPassport || "",
      nationality: formData.nationality || "", position: formData.position || "",
      job_title: formData.position || "", department: formData.department || "",
      company: formData.company || "", employer: formData.company || "",
      work_location: formData.workLocation || "", location: formData.workLocation || "",
      contact_number: formData.contactNumber || "", address: formData.address || "",
      date: formData.date || new Date().toLocaleDateString('id-ID'),
      serv_date: formData.serviceDate || "", med_no: formData.medNo || "",
      ...
      weist: formData.waist || "", p: formData.pulse || "", b_p: formData.bloodPressure || "", rr: formData.respiratoryRate || "",
